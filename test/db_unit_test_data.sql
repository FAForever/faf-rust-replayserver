...
values (11, 'SCMP_001',   'FFA',            'skirmish',  1),`
       (12, 'SCMP_002',   'Astro 20 NR',    'skirmish',  1),
       (13, 'SCMP_003',   'LateNightCanis', 'skirmish',  1),
...
values (21, 'SCMP 001',  8,           1024,  1024,   1,       'maps/scmp_001.zip',       0,      11),
       ...
       (23, NULL,        8,           1024,  1024,   1,       'maps/scmp_000.zip',       0,      13),
...
values (31, 'faf',         'FAF',          'FAF',        1,       'fa.git',      'a',        'nx2',          FALSE),
       ...
       (34, 'labwars',     NULL,           'No files',   1,       'example.git', 'd',        'nx2',          TRUE);
...
values (1000, '2010-01-01 00:00:00', '2010-01-01 01:00:00', '2v2 Game'                 '0',       31,      1,      21,    0),
       ...
       (1050, '2010-01-03 00:00:00', NULL,                  'Game with max nulls',     '0',       666,     666,    NULL,  0),
       (1060, '2010-01-03 00:00:00', NULL,                  'Game with no players',    '0',       31,      1,      21,    0);
       (1070, '2010-01-03 00:00:00', '2010-01-03 01:00:00', 'Game with AI only',       '0',       31,      1,      21,    0);
